...
public class Matrix {
    ...
    private void openFileMatrix() throws FileNotFoundException {
        ...
        if (fileAccess == null) {
            ...
            try {
                ...
                fileAccess = new RandomAccessFile(matrixFile, "rw");
     ...
     * Access to the matrix
     * 
     * @return The RandomAccessFile object used
     */
     ...
     * Access to the matrix
     * 
     * @param fileAccess The RandomAccessFile object to use.
     */
        ...
        if (verifyRange(i, j)) {
            ...
            if (!overFile) {
                ...
                try {
                    ...
                    getFileAccess().seek(pos);

                    value = getFileAccess().readDouble();
     ...
     * by default the the matrix is stored over the main memory
     * 
     * @param overFile Set whether the data will be stored over a file or main memory.
     */
