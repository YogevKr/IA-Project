...
public class XmlFormat {
    ...
    public static void formatXmlFile(File xmlConfiguration,
        ...
        RandomAccessFile read = new RandomAccessFile(xmlConfiguration, "r");
        RandomAccessFile write = new RandomAccessFile(newXmlConfiguration, "rw");
        ...
        while ((line = read.readLine()) != null) {
            ...
            for (int i = 0; i < level; i++) {
                write.writeBytes(identationSymbol);
            }
