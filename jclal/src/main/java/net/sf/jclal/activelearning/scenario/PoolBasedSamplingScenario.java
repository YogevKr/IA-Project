...
public class PoolBasedSamplingScenario extends AbstractScenario {
    ...
    /**
     * Selects the most informative instances of the <b>pool</b> according to the
    ...
    public void instancesSelection() {
        ...
        ((AbstractQueryStrategy) getQueryStrategy()).getSelectedInstances().addAll(getBatchMode().instancesSelection(queryStrategy, seleccion));
    }
    ...
    public void evaluationTest() {
        ...
        try {
            ...
            //Call to the evaluationTest method of the super class
